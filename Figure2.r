...
pdf(file.path(workdir,"Figure2a.pdf"),  onefile=FALSE, width=13, height=6)
#pdf(file.path(workdir,"Figure2b.pdf"),  onefile=FALSE, width=13, height=6)
...
forestplot(labeltext=tabletext, 
          ...
          title ="Medical encounters for TUD diagnosis in patients with T2DM and TUD\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
          #title ="Medical encounters for TUD diagnosis in patients with T2DM and TUD (without obesity)\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
