...
pdf(file.path(workdir,"Supplement_Figure2.pdf"),  onefile=FALSE, width=13, height=6)
...
forestplot(labeltext=tabletext, 
          ...
          title ="Medical encounters for TUD diagnosis in patients with T2DM and TUD (with obesity)\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
