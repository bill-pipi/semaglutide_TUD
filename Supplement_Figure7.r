...
workdir <- "."
#datafile <- file.path(workdir,"Supplement_Figure7a.csv")
#datafile <- file.path(workdir,"Supplement_Figure7b.csv")
datafile <- file.path(workdir,"Supplement_Figure7c.csv")
...
tabletext <- cbind(c("Size/cohort",data$casecount),
...
#pdf(file.path(workdir,"Supplement_Figure7a.pdf"),  onefile=FALSE, width=13, height=6)
#pdf(file.path(workdir,"Supplement_Figure7b.pdf"),  onefile=FALSE, width=13, height=6)
pdf(file.path(workdir,"Supplement_Figure7c.pdf"),  onefile=FALSE, width=13, height=6)
...
forestplot(labeltext=tabletext, 
          ...
          #title ="Congenital malformations, deformations and chromosomal abnormalities in patients with T2DM and TUD\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
          #title ="Congenital malformations, deformations and chromosomal abnormalities in patients with T2DM and TUD (without obesity)\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
          title ="Congenital malformations, deformations and chromosomal abnormalities in patients with T2DM and TUD (with obesity)\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
