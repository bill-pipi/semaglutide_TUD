...
datafile <- file.path(workdir,"Supplement_Figure3.csv")
...
pdf(file.path(workdir,"Supplement_Figure3.pdf"),  onefile=FALSE, width=13, height=6)
...
forestplot(labeltext=tabletext, 
          ...
          is.summary=c(TRUE,rep(FALSE, 150)),
           ...
           lower=c(NA,data$down), upper=c(NA,data$up),
                    ...
                    title ="Smoking cessation medication prescriptions in patients with T2DM and TUD (with obesity)\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
