...
workdir <- "."
#datafile <- file.path(workdir,"Supplement_Figure5a.csv")
#datafile <- file.path(workdir,"Supplement_Figure5b.csv")
datafile <- file.path(workdir,"Supplement_Figure5c.csv")
...
#pdf(file.path(workdir,"Supplement_Figure5a.pdf"),  onefile=FALSE, width=13, height=6)
#pdf(file.path(workdir,"Supplement_Figure5b.pdf"),  onefile=FALSE, width=13, height=6)
pdf(file.path(workdir,"Supplement_Figure5c.pdf"),  onefile=FALSE, width=13, height=6)
...
forestplot(labeltext=tabletext, 
          ...
          #title ="Smoking cessation counseling in patients with T2DM and TUD\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
          #title ="Smoking cessation counseling in patients with T2DM and TUD (without obesity) \n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
          title ="Smoking cessation counseling in patients with T2DM and TUD (with obesity)\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
