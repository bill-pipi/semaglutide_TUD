...
pdf(file.path(workdir,"Figure4a.pdf"),  onefile=FALSE, width=13, height=6)
#pdf(file.path(workdir,"Figure4b.pdf"),  onefile=FALSE, width=13, height=6)
...
forestplot(labeltext=tabletext, 
          ...
          title ="Smoking cessation medication prescriptions in patients with T2DM and TUD\n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
          #title ="Smoking cessation medication prescriptions in patients with T2DM and TUD (without obesity) \n(Comparision between matched semaglutide vs other anti-diabetes medications cohorts)", 
